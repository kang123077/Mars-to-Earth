...
namespace Character
{
    public class M_CR_44:Monster
    {
        ...
        protected override void Attack()
        {
            ...
            positions.Clear();
            travelDistance = 0;
            SpawnManager.Instance.Launch(thisCurTransform.position, target? target.position: thisCurTransform.forward*range, dmg,2 + duration * 0.5f, 20 + speed * 2, range * 0.1f, ref projectileInfo);
