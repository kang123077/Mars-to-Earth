...
public class Hyperion : MonoBehaviour
{
    ...
    private readonly static Vector3[] ports = new Vector3[16]{
    ...
    public void Init(int lm, float dg, float rg, float dr, float sp)
    {
        ...
        projectileInfo = new Projectile.ProjectileInfo(layerMask,
    ...
    private void Update()
    {
        ...
        if (eleapse > 2)
        {
            ...
            for(int i =0;i<4;i++)
            {
                ...
                SpawnManager.Instance.Launch(shotPoint, Vector3.down, dmg, duration * 0.1f, speed, range * 0.5f, ref projectileInfo);
            }
        }
